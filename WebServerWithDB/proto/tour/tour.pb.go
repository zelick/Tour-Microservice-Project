...
func (x *PageRequestTour) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PageRequestTour) ProtoMessage() {}

func (x *PageRequestTour) ProtoReflect() protoreflect.Message {
	mi := &file_tour_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PageRequestTour.ProtoReflect.Descriptor instead.
func (*PageRequestTour) Descriptor() ([]byte, []int) {
	return file_tour_proto_rawDescGZIP(), []int{4}
}

func (x *PageRequestTour) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *PageRequestTour) GetPage() int32 {
	if x != nil {
		return x.Page
	}
	return 0
...
func (x *PageRequestTour) GetPageSize() int32 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
type TourListResponse struct {
	...
	Results    []*TourDto `protobuf:"bytes,1,rep,name=results,proto3" json:"results,omitempty"`
...
func (x *TourListResponse) GetResults() []*TourDto {
	if x != nil {
		return x.Results
	}
	return nil
...
func (x *TourListResponse) GetTotalCount() int32 {
	if x != nil {
		return x.TotalCount
	}
	return 0
...
type TourPublishRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *TourPublishRequest) Reset() {
	*x = TourPublishRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *TourPublishRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TourPublishRequest) ProtoMessage() {}

func (x *TourPublishRequest) ProtoReflect() protoreflect.Message {
	mi := &file_tour_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TourPublishRequest.ProtoReflect.Descriptor instead.
func (*TourPublishRequest) Descriptor() ([]byte, []int) {
	return file_tour_proto_rawDescGZIP(), []int{9}
}

func (x *TourPublishRequest) GetTourId() int64 {
	if x != nil {
		return x.TourId
	}
	return 0
...
var file_tour_proto_rawDesc = []byte{
	...
	0x06, 0x55, 0x73, 0x65, 0x72, 0x49, 0x64, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x55,
	...
	0x75, 0x72, 0x49, 0x64, 0x22, 0x59, 0x0a, 0x0f, 0x50, 0x61, 0x67, 0x65, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x54, 0x6f, 0x75, 0x72, 0x12, 0x16, 0x0a, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49,
	...
	,
	...
	,
...
var file_tour_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_tour_proto_goTypes = []interface{}{
	...
	(*PageRequestTour)(nil),       // 4: PageRequestTour
	(*UserIdRequest)(nil),         // 5: UserIdRequest
	(*TourIdRequest)(nil),         // 6: TourIdRequest
	(*Response)(nil),              // 7: Response
	(*TourListResponse)(nil),      // 8: TourListResponse
	(*TourPublishRequest)(nil),    // 9: TourPublishRequest
	(*timestamppb.Timestamp)(nil), // 10: google.protobuf.Timestamp
}
var file_tour_proto_depIdxs = []int32{
	10, // 0: TourDto.publishedDateTime:type_name -> google.protobuf.Timestamp
	10, // 1: TourDto.archivedDateTime:type_name -> google.protobuf.Timestamp
	...
	10, // 5: TourReviewDto.attendanceDate:type_name -> google.protobuf.Timestamp
	10, // 6: TourReviewDto.reviewDate:type_name -> google.protobuf.Timestamp
	0,  // 7: TourListResponse.results:type_name -> TourDto
	0,  // 8: Tour.Create:input_type -> TourDto
	4,  // 9: Tour.GetByUserId:input_type -> PageRequestTour
	9,  // 10: Tour.Publish:input_type -> TourPublishRequest
	9,  // 11: Tour.Archive:input_type -> TourPublishRequest
	6,  // 12: Tour.Delete:input_type -> TourIdRequest
	0,  // 13: Tour.Create:output_type -> TourDto
	8,  // 14: Tour.GetByUserId:output_type -> TourListResponse
	0,  // 15: Tour.Publish:output_type -> TourDto
	0,  // 16: Tour.Archive:output_type -> TourDto
	0,  // 17: Tour.Delete:output_type -> TourDto
...
func file_tour_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_tour_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TourPublishRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
